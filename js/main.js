...
function nextSlide() {
    ...
    // Keep next slide visible at the start (from right side)
...
function prevSlide() {
    ...
    // Keep prev slide visible at the start (from left side)
